...
/// section by <see cref="PaperbaseVisionLlmOcrModule"/>. The vision model id / endpoint / key are NOT
/// here — those are host deployment concerns wired in <c>PaperbaseHostModule.ConfigureAI</c> as a keyed
